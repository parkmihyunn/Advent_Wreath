...
export default function Footer(){
  return (
    <footer className="text-[#BBBBBB] text-center" onContextMenu={e => e.preventDefault()}>
      <div className="container flex items-center flex-col">
        <div className="flex flex-row">
          ...
          <span className="flex flex-row text-sm text-[#BBBBBB] ml-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-2">
            <Link href="https://www.instagram.com/comeback_reindeer/">
              <a target="_blank" className="text-[#BBBBBB]">
