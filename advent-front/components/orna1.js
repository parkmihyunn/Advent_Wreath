        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 
            ...
            <div className="wreath_back">
                ...
                <div className="wreath_center">
                    {/* <Image src='/img/wreath_non.png' width='267' height='253'></Image>
                    ...
                    <div className="wreath_orna_q1">
                        {/* <Button onClick={handleClickButton} name={data.name} key={data.id}> */}
                            <Image src='/img/ornaments/ball.png' width='29' height='30'></Image>
                        {/* </Button> */}
                    </div>
